...
class SpectralModel(SpectralFitAlgorithm, BaseObject):
    ...
    def __init__(self, peak_width_limits=(0.5, 12.0), max_n_peaks=np.inf, min_peak_height=0.0,
        ...
        # NEW: pull out regularization_weight (default off)
        regularization_weight = float(model_kwargs.pop('regularization_weight', 0.0))
        ...
        # NEW: expose λ on the model (read by your patched peak fitter)
